    ...
    return (
      ...
      <ScrollView>
      	<View style={styles.notificationWrapper}>
   			<View>
	      		<Text style={styles.notificationheaderTitle}>Lebih Awal</Text>
      		...
      		/>
      		<NotificationList 
      			authorImg={{uri: 'https://3er1viui9wo30pkxh1v2nh4w-wpengine.netdna-ssl.com/wp-content/uploads/prod/2014/08/BillGatesHeadshot.jpg'}} 
      			from='Bill Gates' 
      			to='Mark Zuckerberg'
      			time='2 jam yang lalu'
      		/>
      		<NotificationList 
      			authorImg={{uri: 'https://avatars0.githubusercontent.com/u/1024025?s=460&v=4'}} 
      			from='Linus Torvalds' 
      			to='Bill Gates'
      			time='2 jam yang lalu'
      		/>
      		<View>
	      		<Text style={styles.notificationheaderTitle}>Permintaan Pertemanan</Text>
	      		<Divider style={styles.dividerStyle} />
      		</View>
      			{
